...
export default {
  ...
  methods: {
    ...
    exportTable() {
      console.log("Export excel");
      var columns = this.main_year_columns;
    ...
    get_Year_QaPlanCareer() {
      ...
      console.log(" 1 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
    ...
    get_Month_QaPlanCareer() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 2 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
    ...
    getCareer_name() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 3 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
          action: "get_career",
    ...
    getQualification_name() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 4 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
    ...
    getYear() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 5 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
          action: "get_year",
    ...
    getMonth() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 6 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
          action: "get_month",
    ...
    getFilterYear() {
      ...
      axios
        ...
        .then(function (res) {
          console.log("table YEAR:+", res.data);
          self.year_table = res.data;
        })
        .catch(function (error) {
          console.log(error);
    ...
    getFilterMonth() {
      var member_id = Number(this.$store.getters.myMember_id);
      console.log(" 7 แสดงข้อมูลคุณสมบัติ member_id:", member_id);
      var self = this;
      axios
        .post(this.url_api_qa_plan_career, {
        ...
        .then(function (res) {
          console.log("table MONTH:+", res.data);
          self.month_table = res.data;
        })
        .catch(function (error) {
          console.log(error);
